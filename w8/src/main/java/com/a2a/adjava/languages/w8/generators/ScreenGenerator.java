 ...
 * @since MF-Annapurna
 */
public class ScreenGenerator extends AbstractIncrementalGenerator<MW8Domain<MW8Dictionary, MW8ModeleFactory>> {
	...
	private void createScreen(MScreen p_oScreen, 
		...
		String sFile = FileTypeUtils.computeFilenameForCSharpImpl("View", p_oScreen.getName(), p_oMProject.getSourceDir());

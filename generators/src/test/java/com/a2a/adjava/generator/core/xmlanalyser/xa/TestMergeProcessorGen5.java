...
public class TestMergeProcessorGen5 {
...
//	@Test
	public void testMergeProcessor() {
		File oFileResult = new File(ROOT_DIV+"/newmod/result5.xml");
		File oFile = new File(ROOT_DIV+"/newmod/gen5.xml");
		if (oFile.exists()) {
			oFile.delete();
		}
		...
		try {
//			File oFileGen5Oldgen = new File(ROOT_DIV+"/oldgen/gen5.xml");
//			File oFileGen5OldgenT = new File(ROOT_DIV+"/oldgen/gen5.xml");
//			Document oOldgenT = PlistProcessor.fromFlatXmlToGroupedXml(oFileGen5Oldgen, XaConfFile.IOS_PLIST);
//			
//			File oFileGen5Newgen = new File(ROOT_DIV+"/newgen/gen5.xml");
//			File oFileGen5NewgenT = new File(ROOT_DIV+"/newgen/gen5.xml");
//			Document oNewgenT = PlistProcessor.fromFlatXmlToGroupedXml(oFileGen5Newgen, XaConfFile.IOS_PLIST);
//			
//			File oFileGen5Mod = new File(ROOT_DIV+"/mod/gen5.xml");
//			File oFileGen5ModT = new File(ROOT_DIV+"/mod/gen5.xml");
//			Document oModT = PlistProcessor.fromFlatXmlToGroupedXml(oFileGen5Mod, XaConfFile.IOS_PLIST);
//			
//			
//			try {
//				writeXml( new DOMSource(oOldgenT), oFileGen5OldgenT);
//				writeXml( new DOMSource(oNewgenT), oFileGen5NewgenT);
//				writeXml( new DOMSource(oModT), oFileGen5ModT);
//			} catch (Exception e) {
//				// TODO Auto-generated catch block
//				e.printStackTrace();
//			}
			
			oMp.process(Paths.get(ROOT_DIV+"/oldgen","gen5.xml"), Paths.get(ROOT_DIV+"/newgen","gen5.xml"), Paths.get(ROOT_DIV+"/mod/gen5.xml"), Paths.get(ROOT_DIV+"/newmod/gen5.xml"));

...
public class TestMergeProcessorAndroidManifest {
	...
	public void load() throws AdjavaException {
		...
		XmlFileLoader oXmlLoaderOldGen = new XmlFileLoader(Paths.get(ROOT_DIV+"/oldgen"), XmlFileLoader.Type.OLDGEN,"xml","manifest.xml");
		XmlFileLoader oXmlLoaderMod = new XmlFileLoader(Paths.get(ROOT_DIV+"/mod"),  XmlFileLoader.Type.MOD,"xml","manifest.xml");
		XmlFileLoader oXmlLoaderNewGen = new XmlFileLoader(Paths.get(ROOT_DIV+"/newgen"),  XmlFileLoader.Type.NEWGEN,"xml","manifest.xml");
	...
	public void testMergeProcessor() {
		File oFileResult = new File(ROOT_DIV+"/newmod/AndroidManifestResult.xml");
		File oFile = new File(ROOT_DIV+"/newmod/AndroidManifest.xml");
		if (oFile.exists()) {
			oFile.delete();
		}
		...
		try {
			oMp.process(Paths.get(ROOT_DIV+"/oldgen","AndroidManifest.xml"), Paths.get(ROOT_DIV+"/newgen","AndroidManifest.xml"), Paths.get(ROOT_DIV+"/mod/AndroidManifest.xml"), Paths.get(ROOT_DIV+"/newmod/AndroidManifest.xml"));

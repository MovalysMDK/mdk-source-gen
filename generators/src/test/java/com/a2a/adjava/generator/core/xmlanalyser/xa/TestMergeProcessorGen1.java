...
public class TestMergeProcessorGen1 {
	...
	public void load() throws AdjavaException {
		...
		XmlFileLoader oXmlLoaderOldGen = new XmlFileLoader(Paths.get(ROOT_DIV+"/oldgen"), XmlFileLoader.Type.OLDGEN,"xml","conf2.xml");
		XmlFileLoader oXmlLoaderMod = new XmlFileLoader(Paths.get(ROOT_DIV+"/mod"),  XmlFileLoader.Type.MOD,"xml","conf2.xml");
		XmlFileLoader oXmlLoaderNewGen = new XmlFileLoader(Paths.get(ROOT_DIV+"/newgen"),  XmlFileLoader.Type.NEWGEN,"xml","conf2.xml");
	...
	public void testMergeProcessor() {
		File oFileResult = new File(ROOT_DIV+"/newmod/result2.xml");
		File oFile = new File(ROOT_DIV+"/newmod/gen2.xml");
		if (oFile.exists()) {
			oFile.delete();
		}
		...
		try {
			oMp.process(Paths.get(ROOT_DIV+"/oldgen","gen2.xml"), Paths.get(ROOT_DIV+"/newgen","gen2.xml"), Paths.get(ROOT_DIV+"/mod/gen2.xml"), Paths.get(ROOT_DIV+"/newmod/gen2.xml"));

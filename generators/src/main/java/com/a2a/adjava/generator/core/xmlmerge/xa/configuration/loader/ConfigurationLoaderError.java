...
/**
 * Classe d'erreur du chargeur de code
 * @author smaitre
 *
 */
public class ConfigurationLoaderError extends AbstractXALoaderError<CONFIGURATION_LOADER_ERROR_TYPE>{
	 ...
	 */
	public ConfigurationLoaderError(CONFIGURATION_LOADER_ERROR_TYPE p_oType, String p_sLocalisation, int p_iPosition) {

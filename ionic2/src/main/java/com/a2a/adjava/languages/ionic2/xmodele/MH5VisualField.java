...
public class MH5VisualField extends MVisualField {
	
	/**
	 * Create a new visual field from existing one
	 * @param p_oField existing visual field
	 */
	public MH5VisualField(MVisualField p_oField) {
		super(p_oField);
	}
	 ...
	 */
	public MH5VisualField(String p_sPath, MVisualField p_oField, MLabel p_oLabel) {
	 ...
	 */
	public MH5VisualField(String p_sName, MLabel p_oLabel,	String p_sComponent, MVFLabelKind p_oLabelKind,
	 ...
	 */
	public MH5VisualField(String p_sName, MLabel p_oLabel,

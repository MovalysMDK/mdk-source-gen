 ...
 */
package com.a2a.adjava.languages.ionic2.extractors;

import com.a2a.adjava.languages.ionic2.extractors.views.ExitStateDlg;
import com.a2a.adjava.languages.ionic2.extractors.views.ViewBasicAttrDlg;
import com.a2a.adjava.languages.ionic2.extractors.views.ViewComboDlg;
import com.a2a.adjava.languages.ionic2.extractors.views.ViewFixedListDlg;
import com.a2a.adjava.languages.ionic2.extractors.views.ViewFormDlg;
import com.a2a.adjava.languages.ionic2.extractors.views.ViewListDlg;
...
public class ViewExtractor extends AbstractExtractor<MH5Domain<MH5Dictionary, MH5ModeleFactory>> {
    ...
    protected MH5View createViewFromScreen(MScreen p_oScreen) {
        ...
        for (MPage oPage : pages) {
            ...
            int p_iColumn = 1;
            int p_iSection = 1;
            String l_sColumn = oPage.getParameterValue(MWorkspaceConfig.COLUMN_PARAMETER);
            String l_sSection = oPage.getParameterValue(MWorkspaceConfig.SECTION_PARAMETER);
            if (l_sColumn != null) {
                p_iColumn = Integer.parseInt(l_sColumn);
            }
            if (l_sSection != null) {
                p_iSection = Integer.parseInt(l_sSection);
            }
            r_oNewView.addNestedSubview(oPage.getName(), oPage.getViewModelImpl().getType(), isFirstDetail, p_iColumn, p_iSection);

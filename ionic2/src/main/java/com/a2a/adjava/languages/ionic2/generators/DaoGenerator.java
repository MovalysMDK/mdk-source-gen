...
import com.a2a.adjava.languages.ionic2.xmodele.MH5ImportDelegate;
...
public class DaoGenerator extends AbstractIncrementalGenerator<IDomain<MH5Dictionary, MH5ModeleFactory>> {
    ...
    private static final String docPathDaoMapping = "app/data/dao/mappings";
    private static final String docPathDaoProxy = "app/data/dao";
    private static final String docPathDaoSql = "app/data/dao/sql";
    private static final String docPathDaoNoSql = "app/data/dao/nosql";

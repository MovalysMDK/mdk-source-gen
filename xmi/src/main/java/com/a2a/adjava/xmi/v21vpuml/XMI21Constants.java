...
public final class XMI21Constants {
	 ...
	 */
	public static final Namespace XMI2011_NAMESPACE = new Namespace("xmi", "http://schema.omg.org/spec/XMI/2.1");
	 ...
	 * Xmi id attribute
	 */
	public static final QName XMIIDREF2011_ATTR = new QName("idref", XMI2011_NAMESPACE);	
	
	/**
	 * Xmi id attribute
	 */
	public static final QName XMIID2011_ATTR = new QName("id", XMI2011_NAMESPACE);

	/**
	 * Xmi Type attribute
	 */
	public static final QName XMITYPE_ATTR = new QName("type", XMI2011_NAMESPACE);
	 ...
	 * Xmi value attribute
	 */
	public static final QName XMIVALUE2011_ATTR = new QName("value", XMI2011_NAMESPACE);
	 ...
	 */
	public static final QName PACKAGEELEMENT_NODE = new QName("ownedMember", Namespace.NO_NAMESPACE);
	 ...
	 * Extension node
	 */
	public static final QName XMIEXTENSION_NODE = new QName("Extension", XMI2011_NAMESPACE);
	 ...
	 * client node
	 */
	public static final QName CLIENT_ATTR = new QName("client", Namespace.NO_NAMESPACE);
	
	/**
	 * supplier node
	 */
	public static final QName SUPPLIER_ATTR = new QName("supplier", Namespace.NO_NAMESPACE);
	 ...
	 * Documentation node
	 */
	public static final QName DOCUMENTATION_NODE = new QName("Documentation", XMI2011_NAMESPACE);
	
	/**
	 * exporter node
	 */
	public static final QName EXPORTER_NODE = new QName("exporter", XMI2011_NAMESPACE);
	
	/**
	 * exporterVersion node
	 */
	public static final QName EXPORTERVERSION_NODE = new QName("exporterVersion", XMI2011_NAMESPACE);
}

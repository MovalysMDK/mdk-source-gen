...
import static com.a2a.adjava.xmi.v21mduml.XMI21Constants.DEFAULTVALUE_NODE;
import static com.a2a.adjava.xmi.v21mduml.XMI21Constants.NAME_ATTR;
import static com.a2a.adjava.xmi.v21mduml.XMI21Constants.OWNEDATTRIBUTE_DERIVED_ATTR;
...
import static com.a2a.adjava.xmi.v21mduml.XMI21Constants.TYPE_NODE;
 ...
 * 
 */
public class XMI21AttributeReader {

	/**
	 * Logger for this class
	 */
	private static final Logger log = LoggerFactory.getLogger(XMI21AttributeReader.class);

	/**
	 * Singleton attribute reader
	 */
	private static XMI21AttributeReader attributeReader = new XMI21AttributeReader();

	/**
	 * Return singleton instance
	 * @return singleton instance
	 */
	protected static XMI21AttributeReader getInstance() {
...
//			</ownedAttribute>
		...
		if ( StringUtils.isNotBlank(sAttrName)) {
			...
			// Read documentation
			String sDocumentation = XMI21DocReader.getInstance().readDoc(p_xAttr, StringUtils.join("Attribute:", p_oClass.getName(), StrUtils.DOT_S, sAttrName ));
	...
	private UmlDataType readType( Element p_xOwnedAttribute, UmlDictionary p_oModelDictonnary ) {
		...
		if ( xType != null ) {
			...
			if ( sHref.startsWith("http://www.omg.org/spec/UML/20110701/PrimitiveTypes.xmi")) {

...
import static com.a2a.adjava.xmi.v21mduml.XMI21Constants.STEREOTYPE_STEREOTYPEHREF_ATTR;
...
public final class XMI21StereotypeReader {
	...
	protected void readStereotypes( Element p_xModel, UmlDictionary p_oModelDictonary ) throws Exception {
		...
		for (Element xStereotype : (List<Element>) p_xModel.getParent().selectNodes(
				"./*[ namespace-uri() = 'http://www.omg.org/spec/XMI/20110701' and local-name() = 'Extension']/stereotypesHREFS/stereotype")) {			
	...
	protected UmlStereotype readStereoType(Element p_xStereotype,
		...
		r_oUmlStereotype.setDocumentation(XMI21DocReader.getInstance().readDoc(p_xStereotype, StringUtils.join("Stereotype: ", sFullName)));

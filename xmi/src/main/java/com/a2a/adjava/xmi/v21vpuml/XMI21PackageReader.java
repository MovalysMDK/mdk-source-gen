...
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_NODE;
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_TYPE_ASSOCIATION;
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_TYPE_ASSOCIATIONCLASS;
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_TYPE_CLASS;
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_TYPE_ENUMERATION;
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_TYPE_PACKAGE;
import static com.a2a.adjava.xmi.v21vpuml.XMI21Constants.PACKAGEELEMENT_TYPE_USAGE;
 ...
 * 
 */
public final class XMI21PackageReader {

	/**
	 * Logger
	 */
	private static final Logger log = LoggerFactory.getLogger(XMI21PackageReader.class);

	/**
	 * Singleton instance
	 */
	private static XMI21PackageReader packageReader = new XMI21PackageReader();
	 ...
	 */
	protected static XMI21PackageReader getInstance() {
	...
	protected UmlPackage readPackage(Element p_xPackage, UmlPackage p_oParent,
		...
		// XMI example :
		// <ownedMember isAbstract="false" isLeaf="false" name="com" visibility="public" xmi:id="CW0goAqAUDAUUQ6Q" xmi:type="uml:Package">
	...
	protected void processChildren(Element p_xParent, UmlPackage p_oParent, UmlDictionary p_oModelDictonary,
		...
		for (Element xPackagedElement : (List<Element>) p_xParent.elements(PACKAGEELEMENT_NODE)) {
			...
			// Class
				...
				UmlClass oClass = XMI21ClassReader.getInstance().readClass(xPackagedElement, p_oParent,

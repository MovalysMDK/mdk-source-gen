 ...
 *
 */
public final class XMI24DocReader {

	/**
	 * Singleton instance
	 */
	private static XMI24DocReader docReader = new XMI24DocReader();
		
	/**
	 * Return singleton instance
	 * @return singleton instance
	 */
	protected static XMI24DocReader getInstance() {
		return docReader ;
	}

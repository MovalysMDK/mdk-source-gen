 ...
 *
 */
public class MIOSVisualField extends MVisualField {
	 ...
	 */
	public MIOSVisualField(MVisualField p_oField) {
		super(p_oField);
		this.cellType = ((MIOSVisualField) p_oField).getCellType();
	}
	 ...
	 */
	public MIOSVisualField(String p_sPath, MVisualField p_oField, MLabel p_oLabel) {
	 ...
	 */
	public MIOSVisualField(String p_sName, MLabel p_oLabel,	String p_sComponent, MVFLabelKind p_oLabelKind,
	 ...
	 */
	public MIOSVisualField(String p_sName, MLabel p_oLabel,
	...
	protected void toXmlInsertBeforeDocumentation(Element p_xElement) {
		...
		if ( this.getCellType() != null ) {
			p_xElement.addElement("cellType").setText( this.getCellType() );
		}		
	}
}

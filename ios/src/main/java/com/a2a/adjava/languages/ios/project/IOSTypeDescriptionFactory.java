...
/**
 * Type description factory for IOS
 * @author lmichenaud
 *
 */
public class IOSTypeDescriptionFactory extends TypeDescriptionFactory {
	...
	public TypeDescription createTypeDescription(Element p_xType) throws Exception {
		IOSTypeDescription r_oOCTypeDescription = new IOSTypeDescription();
		fillTypeDescription(p_xType, r_oOCTypeDescription);
		return r_oOCTypeDescription;
	}
	...
	protected void fillTypeDescription(Element p_xType, ITypeDescription p_oTypeDescription) throws Exception {
		...
		IOSTypeDescription oIOSTypeDescription = (IOSTypeDescription) p_oTypeDescription;
		oIOSTypeDescription.setCoreDataType(p_xType.elementText("coredata-type"));
		BeanUtils.setStringIfNotNull(oIOSTypeDescription, "vmBinded", p_xType.elementText("vm-binded"));
	}
}
